    ...
    <section id="contact" className="py-16 sm:py-20 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-16">
          ...
          >
            <span className="text-accent-500">Хамтдаа эхлүүлцгээе</span>
          </h2>
          <p
            className="hero-reveal text-gray-500 text-base sm:text-lg"
            style={{ animationDelay: "0.4s" }}
          >
            Оффис түрээслэх, барилга захиалах эсвэл хөрөнгө оруулалт судлах бол
            манай баг бэлэн хүлээж байна.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-gray-400 text-xs sm:text-sm mb-3">
                  Түрээсийн хэлтсийн дарга — одоо боломжтой
                </div>
                <a
          ...
          >
            <h3 className="text-lg sm:text-xl font-bold text-brand-900 mb-5 sm:mb-6">
              Лавлагаа илгээх
            </h3>

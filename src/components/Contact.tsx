      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-brand-900 mb-4">
            <span className="text-accent-500">Яриа эхлүүлцгээе</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          {/* Left */}
          <div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-1 gap-4 sm:gap-5 mb-8">
            ...
            {/* Agent card */}
            <div className="bg-brand-900 rounded p-5 sm:p-6 flex items-center gap-4 sm:gap-5">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-white font-bold text-sm sm:text-base">Оюунгэрэл Цэнд</div>
                <div className="text-gray-400 text-xs sm:text-sm mb-3">Түрээсийн хэлтсийн дарга — одоо боломжтой</div>
                <a
                  href="tel:+97699224455"
          ...
          {/* Right: form */}
          <div className="bg-brand-50 border border-gray-100 rounded p-5 sm:p-8">
            <h3 className="text-lg sm:text-xl font-bold text-brand-900 mb-5 sm:mb-6">Лавлагаа илгээх</h3>
            <form className="flex flex-col gap-4 sm:gap-5">
              <div className="grid grid-cols-1 xs:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-brand-900 mb-1.5">Нэр</label>
                  <input type="text" placeholder="Бат-Эрдэнэ"
              ...
              <div>
                ...
                <textarea rows={4} placeholder="Шаардлагаа бичнэ үү — талбай, байршил, хугацаа…"
